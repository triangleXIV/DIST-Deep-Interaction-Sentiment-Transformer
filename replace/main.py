...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='dist', type=str,)
    parser.add_argument('--dataset', default='twitter', type=str, help='restaurant, laptop, zol_cellphone')
    ...
    parser.add_argument('--eval_step', default=30, type=int)

    parser.add_argument('--max_seq_len', default=64, type=int)
    parser.add_argument('--max_aspect_len', default=16, type=int)
    parser.add_argument('--max_img_len', default=4, type=int)
    ...
    for i in range(10):
        ...
        print("bestf1:{},bestacc:{}".format(best_f1,best_acc))
